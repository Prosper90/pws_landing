      ...
      {isMobileMenuOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <button 
              className="flex justify-between items-center w-full px-3 py-2 text-base font-medium text-gray-900 hover:bg-gray-50"
              onClick={() => setIsResourcesOpen(!isResourcesOpen)}
            >
              Resources
              <ChevronDown className="ml-1 h-4 w-4" />
            ...
            {isResourcesOpen && (
              <div className="pl-4">
                <a href="#" className="block px-3 py-2 text-base font-medium text-gray-900 hover:bg-gray-50">All Resources</a>
                <a href="#" className="block px-3 py-2 text-base font-medium text-gray-900 hover:bg-gray-50">Community</a>
                <a href="#" className="block px-3 py-2 text-base font-medium text-gray-900 hover:bg-gray-50">Events</a>
              </div>
            )}
            <a href="#" className="block px-3 py-2 text-base font-medium text-gray-900 hover:bg-gray-50">
              Contact Us
